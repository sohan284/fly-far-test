...
const SkillSection = () => {
  ...
  <div className='max-w-[1000px] mx-auto pb-20'>
         <h1
          data-aos="fade-up"
          className="pt-[8%] text-[#a4de5e] font-extrabold font-serif text-[32px] max-w-[800px] mx-auto px-3 text-center"
        >
      ...
      >
        {/* Slide 1 */}
        <SwiperSlide>
         <div className='md:h-[400px] h-[200px] md:ml-0 -ml-[75%]'>
         <div
            className={`transition-all duration-300 ${
              activeIndex === 0 ? 'h-[100%] ' : 'h-[60%]'
            }`}
          >
        ...
        {/* Slide 2 */}
        <SwiperSlide>
         <div className={`md:h-[400px] h-[200px] ${activeIndex === 0 ? ' -mr-[75%] md:mr-0':activeIndex===2 ? '-ml-[75%] md:ml-0' : "m-0"}`}>
         <div
            className={`transition-all duration-300 ${
              activeIndex === 1 ? 'h-[100%]' : 'h-[60%]'
            }`}
          >
        ...
        {/* Slide 3 */}
        <SwiperSlide>
         <div className='md:h-[400px] h-[200px] md:mr-0 -mr-[75%]'>
         <div
            className={`transition-all duration-300 ${
              activeIndex === 2 ? 'h-[100%]' : 'h-[60%]'
            }`}
          >
